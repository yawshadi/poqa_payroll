     ...
     public function mainpayroll(){
        ...
        if(isset($_POST['mainpayrollbtn'])){
          ...
          foreach($empdata as $get){
            ...
            $weekdays = $fix->weekdays;
            $officerbasic = $fix->officerbasic;
            $officertransport = $fix->officertransport;
            ...
            $weekdaypresentdays =  $rec->weekdayspresent;
            $saturdaypresentdays =  $rec->saturdaypresentdays;
            $sundaypresentdays =  $rec->sundaypresentdays;
            $holidaypresentdays =  $rec->holidaypresentdays;
            $companytimehours = $rec->companytimehours;
            $officerotherallowance = $rec->officerotherallowances;
            $officerotherdeduction = $rec->officerotherdeductions;
            ...
            if($totalwage > 1500 ){$taxable = $overallgross - $ssfemp;}
             ...
             $fixovertime =  Calculations::fixovertime($officerbasic);
             $weekdaypresentsalary =  Calculations::weekdaypresentsalary($officerbasic, $officertransport, $fixovertime);
             $weekdaydailyrate =  Calculations::weekdaydailyrate($officerbasic, $weekdays);
             $weekendrate = Calculations::weekendrate($weekdaydailyrate);
             $holidayrate = Calculations::holidayrate($weekdaydailyrate);

              $weekdaysalary = Calculations::weekdaysalary($weekdaypresentdays, $weekdaydailyrate);
              $saturdaysalary = Calculations::saturdaysalary($saturdaypresentdays, $weekendrate);
              $sundaysalary = Calculations::sundaysalary($sundaypresentdays, $weekendrate);
              $holidaysalary =  Calculations::holidaysalary($holidaypresentdays, $holidayrate);
              $officertandtpresent = Calculations::officertandtpresent($officertransport, $weekdays, $weekdaypresentdays);
              $fixedovertimepresent = Calculations::fixedovertimepresent($fixovertime, $weekdays, $weekdaypresentdays);
              $officertotalovertime  = Calculations::officertotalovertime($saturdaysalary, $sundaysalary, $holidaysalary, $fixedovertimesalary);

              $officergross= Calculations::officergross($weekdaysalary, $saturdaysalary, $sundaysalary, $holidaysalary, $officertandtpresent, $fixedovertimesalary, $officerotherallowance, $officerotherdeduction);
              $acturebasic = Calculations::acturebasic($officerbasic, $weekdays, $weekdaypresentdays);
              $officerovertimetax = Calculations::officerovertimetax($weekdaysalary, $officertotalovertime);
              $officerssf = Calculations::officerssf($acturebasic);
              $officertaxable = Calculations::officertaxable($weekdaysalary,  $officergross, $officerssf, $officertotalovertime);
              $officerpaye = Calculations::paye($officertaxable);
              $officertotaltax = $officerpaye + $officerovertimetax;
              $officertotaldeduction = $officerssf + $officertotaltax;
              $officernetpay = $officergross - $officertotaldeduction;
              $officerssnitcompany = $acturebasic * 0.13;
              $officertotalsalarycost = $officergross + $officerssnitcompany;
             ...
             $payrolldata[] = [
                              ...
                              'weekdays'=>$weekdays, 'officerbasic'=>$officerbasic, 'officertransport'=>$officertransport,
                              'fixovertime'=>$fixovertime, 'weekdayspresentsalary'=>$weekdaypresentsalary, 'weekdaydailyrate'=>$weekdaydailyrate,
                              'weekendrate'=>$weekendrate, 'holidayrate'=>$holidayrate, 'weekdaypresentdays'=>$weekdaypresentdays,
                              'weekdaysalary'=>$weekdaysalary,
                              'saturdaypresentdays'=>$saturdaypresentdays, 'sundaypresentdays'=>$sundaypresentdays,
                              'holidaypresentdays'=>$holidaypresentdays, 'companytimehours'=>$companytimehours,
                              'officerotherallowances'=>$officerotherallowance, 'officerotherdeductions'=>$officerotherdeduction,
                              'saturdaysalary'=>$saturdaysalary, 'sundaysalary'=>$sundaysalary, 'holidaysalary'=>$holidaysalary,
                              'officertandtpresent'=>$officertandtpresent, 'fixedovertimepresent'=>$fixedovertimepresent,
                              'officertotalovertime'=>$officertotalovertime, 'officergross'=>$officergross, 'acturebasic'=>$acturebasic,
                              'officerovertimetax'=> $officerovertimetax, 'officerssf'=>$officerssf, 'officertaxable'=>$officertaxable,
                              'officerpaye'=>$officerpaye, 'officertotaltax' => $officertotaltax ,  'officertotaldeduction'=> $officertotaldeduction,
                              'officernetpay'=> $officernetpay,  'officerssnitcompany' => $officerssnitcompany,
                              'officertotalsalarycost'=>$officertotalsalarycost
                             ];
       ...
       public function payslip($employeeid){
        ...
        if(isset($_POST['slipbtn'])){
          ...
          $payrolldata = [];
            ...
            $payrolldata[] = ['company'=>$company, 'department'=>$department, 'position'=>$position,
                              'basic_salary'=>$basic_salary, 'gross'=>$gross, 'overtime'=>$weekday_overtime_rate,
                              'paye'=>$paye, 'otherdeductions'=>$otherdeductions, 'otherallowances'=>$otherallowance,
                              'ssnitbasic'=>$ssfbasic, 'ssnitpercent'=>$ssnitpercent, 'ssnitocompany'=>$ssnitocompany,
                              'totaldeduction'=>$totaldeduction, 'netsalary'=>$netpay, 'overallgross'=>$overallgross,
                              'fullname'=>$fullname, 'staffid'=>$staffid, 'tinnumber'=>$tinnumber, 'totalssf'=>$totalssf,
                              'bank'=>$bank, 'branch'=>$branch, 'accountnumber'=>$accountnumber, 'ssnitnumber'=>$ssnitnumber,
                              'tiernumber'=>$tiernumber, 'overtimetax'=>$overtimetax, 'nightshiftallowance'=>$nightshiftallowance,
                              'weekdayovertimehours'=>$weekday_overtime, 'weekdayovertimerate'=>$weekday_overtime_rate,
                              'weekdayovertimeallowance'=>$weekdayovertimeallowance, 'holidayandweekendovertimehours'=>$holiday_weekend_overtime,
                              'holidayandweekendovertimerate'=>$holiday_overtime_rate,
                              'holidayandweekendovertimeallowance'=>$holidayandweekovertimeallowance,
                              'numberofdaysworked'=>$weekday_dayshift, 'weekdayhourlyrate'=>$weekday_hourly_rate,
                              'nighthours'=>$weekday_nightshift];
