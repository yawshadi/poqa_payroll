...
.form-control{
  ...
  <div class="container-fluid main_container" style='margin-top:-10px'>
      ...
      <div class="row">
        <div class="col-12">
          <h1 style='color:#FB6600; font-weight:700' class="page-title"> EMPLOYEE TIER 2 REPORT </h1>
        </div>
   </div>
...
<div class="row" style="margin-bottom:20px">  
      ...
      <table  class='table table-bordered table-condensed apptables' style='font-size:12px'>
       ...
       <td><button type='submit' name='tierbtn' class='btn btn-warning'>Search</button></td>
    ...
    <div><a style='font-size:10px' href='<?php echo URLROOT  ?>/excelreport/tierexcel/<?php echo $data['startdate'] ?>/<?php echo $data['enddate'] ?>/<?php echo urlencode($data['companyid']) ?>' 
