...
<div class="content-wrapper" style="background: #fafafa">
    ...
    <div class="container-fluid main_container" style='margin-top:-10px'>
        ...
        <div class="row">
            <div class="col-12">
                <h1 style='color:#FB6600; font-weight:700' class="page-title"> PROVEDENT FUND REPORT </h1>
            </div>
        </div>
                        ...
                        <div align='center'>
                            ...
                            <?php if(isset($data['payrolldata'])): ?>
                                <div style='width:100%; margin-top:10px'>
                                    <div><a style='font-size:10px' href='<?php echo URLROOT  ?>/provident/excel/<?php echo $data['startdate'] ?>/<?php echo $data['enddate'] ?>/<?php echo urlencode($data['companyid']) ?>'
