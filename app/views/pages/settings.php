    ...
    <div class="container-fluid main_container">
      ...
      <table  class="display nowrap apptables" cellspacing="0" width="100%" style="font-size:0.750em">
            ...
            <tr>
							...
							<td><?php checkStatus($get-status)  ?></td>
              <td><input type='checkbox' class='billingchk' c_index='<?php echo $get->uid  ?>' 
              <?php checkAdminStatus($get->billingstatus)    ?>/></td> 
              
              <td align='center'><a href='#' style='color:#111111' class='ltstatus'
							i_index='<?php echo $get->uid  ?>'><i class='fa fa-unlock'></i></a></td>
					  
							<td align='center'><a href='#' style='color:red' class='atstatus'
								  i_index='<?php echo $get->uid  ?>'><i class='fa fa-lock'></i></a></td>
							<td align='center'>
								<a href='#' style='color:red' class='destatus'
								  i_index='<?php echo $get->uid  ?>'><i class='fa fa-trash-o'></i></a>
							</td>
