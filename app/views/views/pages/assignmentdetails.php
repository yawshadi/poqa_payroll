...
<div class="content-wrapper">
  <?php //echo '<pre/>'; print_r($data)   ?>
     ...
     <div style='padding-left:20px; color:#7F400B'><h3>Task Assignment</h3></div>
     <hr/>
    <div class="container-fluid main_container">
      ...
      <table>
        <tr>
         <td width='80%'><h5 style='color:#800800'>Provide / Submit  Your Feedback</h5></td>
         <td width='20%'>
           <button type='submit' class="ui orange button" name='submitfeedback'
      ...
      <table class='table table-bordered'>
        <tr>
         ...
         <td colspan = '2'><textarea name='feedback' rows='7' class='form-control'> </textarea></td>
        </tr>
        <tr>
         <td>Attach Supporting Document(s)</td>
         <td><input type="file" name="supportingdocs" id="subdoc" style="font-size:10px" /></td>
        </tr>
      </table>
    ...
    <h5 style='color:#800800'>Supporting Document(s)</h5>
   <table class='table table-bordered'>
     <tr style="font-weight:700; font-size:15px">
       <td>Document</td>
       <td align='center'>Download</td>
  ...
  var uroot = '<?php echo URLROOT.'/task/savesupporting/'.$data['details']->id ?>';
