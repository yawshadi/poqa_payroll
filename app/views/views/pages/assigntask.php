          ...
          <br/>
            ...
            <tr>
              <td width='25%' >
                ...
                <span style='font-size:15px; font-weight:700; color: #800800'>SELECT A TASK TO ASSIGN</span></td>
              <td width='50%' >

               <select   class="tasklist"  style='width:500px' name=taskid>
                <?php
                  foreach($data['task'] as $get):
                 ?>
                <option value='<?php  echo $get->id  ?>'><?php echo $get->taskname  ?></option>
                <?php
                endforeach;
                 ?>
               </select>
              </td>
              <td>  <button class="ui orange button" name='searchtask'> Next <i class="right arrow icon"></i> </button></td>
            </tr>
          </table>
          <br/>
          <div>
