...
.form-control{
  ...
  <div class="container-fluid main_container" style='margin-top:-10px'>
      ...
      <div class="row">
        <div class="col-10">
          <h1 style='color:#FB6600; font-weight:700' class="page-title"> GRIEVANCE REPORTING</h1>
        </div>

        <div class="col-2">
         <div style='margin-top:10px'><a class='btn btn-danger' style='font-size:11px' href='<?php echo URLROOT.'/downloads/grievance.docx'  ?>'><i class='fa fa-download'></i>  Download Form </a></div>
        </div>
   </div>
...
<div class="row" style="margin-bottom:20px">
     ...
     <tr>
         ...
         <td><button type='button' id='grievancebtn' style='font-size:10px' class='btn btn-primary'>
