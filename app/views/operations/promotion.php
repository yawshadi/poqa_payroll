...
.form-control{
  ...
  <div class="container-fluid main_container" style='margin-top:-10px'>
      ...
      <div class="row">
        <div class="col-10">
          <h1 style='color:#FB6600; font-weight:700' class="page-title"> PROMOTIONS REPORTING</h1>
        </div>
...
<div class="row" style="margin-bottom:20px">
     ...
     <tr>
         ...
         <td><button type='button' id='promotionbtn' style='font-size:10px' class='btn btn-primary'>
