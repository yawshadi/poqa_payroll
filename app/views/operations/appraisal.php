...
<div class="row" style="margin-bottom:20px">
     ...
     <table class='table'>
     <tr>
         <td width=50%><input type="text" class="form-control bom employeename"  id="empname" placeholder="Search Employee Name, StaffID or Telephone"/></td>
         <td><button type='button' id='appraisalbtn' style='font-size:10px' class='btn btn-primary'>
