...
.form-control{
  ...
  <div class="container-fluid main_container" style='margin-top:-10px'>
      ...
      <div class="row">
        ...
        <div class="col-2">
         <div style='margin-top:10px'><a class='btn btn-danger' style='font-size:11px' href='<?php echo URLROOT.'/downloads/leave.docx'  ?>'><i class='fa fa-download'></i>  Download Form </a></div>
        </div>
   </div>
